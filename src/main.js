...
seoHeader.onclick = () => {selectService(seoParagraph, `Did you know that 68% of online experiences begin with a search engine (<a onclick='window.open("https://videos.brightedge.com/research-report/BrightEdge_ChannelReport2019_FINAL.pdf", "_blank", "width=400, height=400");'>Link</a>), 92.96% of global traffic comes from Google (Sparktoro), and only 0.78% of Google searchers click on results from the 2nd page (Backlinko)? If you want customers who are searching for your product or service to find your business it is imperative that you use search engine optimization to bring your company up in the search results and avoid becoming a needle in a haystack.`)};
emailAndSMSHeader.onclick = () => {selectService(emailAndSMSParagraph, `Email marketing and SMS marketing are great tools to generate new leads and keep your current customers up to date with the latest information about your business. A recent study has shown that for every dollar your company spends on email marketing alone you can expect a return of $42 and according to Gartner Marketing and Communications 98% of text messages sent are viewed by the receiver. If you’re interested in reaching out to new potential clients or you simply want a direct communication channel with your customers that you could use to launch new sales or products you can not go wrong with email marketing or SMS marketing. Not sure which one is right for you? No problem, give us a call and we can find a plan that best suits your needs.`)};
